...
class RoomManager {
   public:
      ...
      static void sendResponse(const int socket, const std::string& roomName, chat::Response_Type respType, chat::Response_ResultCode rCode, const std::string& desc, const std::string& userName);
   ...
   private:
      void processDelivery(int socket, const std::string& roomName, const std::string& roomPassword, const std::string& userName,
                           const std::string& userPassword, const std::string& content);
      void processRoomCreation(int clientSocket, const std::string& roomName, const std::string& roomPassword,
